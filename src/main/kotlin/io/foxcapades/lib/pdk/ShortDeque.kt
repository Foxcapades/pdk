...
class ShortDeque : PrimitiveDeque<Short, ShortArray> {
   ...
   * deque.
   */
  fun pushTail(values: ShortArray) {
   ...
   * deque.
   */
  inline fun pushLast(values: ShortArray) = pushTail(values)
   ...
   * deque.
   */
  inline fun pushBack(values: ShortArray) = pushTail(values)
  ...
  inline operator fun plusAssign(values: ShortArray) = pushTail(values)
