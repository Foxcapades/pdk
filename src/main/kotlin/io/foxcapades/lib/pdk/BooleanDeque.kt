...
class BooleanDeque : PrimitiveDeque<Boolean, BooleanArray> {
   ...
   * deque.
   */
  fun pushTail(values: BooleanArray) {
   ...
   * deque.
   */
  inline fun pushLast(values: BooleanArray) = pushTail(values)
   ...
   * deque.
   */
  inline fun pushBack(values: BooleanArray) = pushTail(values)
  ...
  inline operator fun plusAssign(values: BooleanArray) = pushTail(values)
