...
class ByteDeque : PrimitiveDeque<Byte, ByteArray> {
   ...
   * deque.
   */
  inline fun pushLast(values: ByteArray) = pushTail(values)
   ...
   * deque.
   */
  inline fun pushBack(values: ByteArray) = pushTail(values)
  ...
  inline operator fun plusAssign(values: ByteArray) = pushTail(values)
