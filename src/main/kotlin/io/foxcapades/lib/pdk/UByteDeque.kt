...
class UByteDeque : PrimitiveDeque<UByte, UByteArray> {
  ...
  /**
   * Constructs a new, empty [UByteDeque] instance.
   *
  ...
  /**
   * Constructs a new [UByteDeque] instance copying the given values.
   *
  ...
  /**
   * Constructs a new [UByteDeque] instance wrapping the given values.
   *
   ...
   * @param value Value that will be pushed onto the front of this deque.
   */
  inline fun pushHead(value: UByte) = push(value)
   ...
   * @param value Value that will be pushed onto the front of this deque.
   */
  inline fun pushFirst(value: UByte) = push(value)
   ...
   * @param value Value that will be pushed onto the front of this deque.
   */
  inline fun pushFront(value: UByte) = push(value)
   ...
   * @throws NoSuchElementException If this deque is empty.
   */
  inline fun popLast(): UByte = popTail()
   ...
   * @throws NoSuchElementException If this deque is empty.
   */
  inline fun popBack(): UByte = popTail()
   ...
   * @param value Value that will be pushed onto the back of this deque.
   */
  inline fun pushLast(value: UByte) = pushTail(value)
   ...
   * @param value Value that will be pushed onto the back of this deque.
   */
  inline fun pushBack(value: UByte) = pushTail(value)
   ...
   * @param value Value that will be pushed onto the back of this deque.
   */
  inline operator fun plusAssign(value: UByte) = pushTail(value)
  ...
  override fun pushTail(values: UByteArray) {
  ...
  override fun pushTail(values: Collection<UByte>) {
    ensureCapacity(size + values.size)
    for (v in values)
      pushTail(v)
  }
   ...
   */
  fun pushTail(values: UByteDeque) {
   ...
   * @param values Deque that will be pushed onto the back of this deque.
   */
  inline fun pushLast(values: UByteDeque) = pushTail(values)
   ...
   * @param values Deque that will be pushed onto the back of this deque.
   */
  inline fun pushBack(values: UByteDeque) = pushTail(values)
   ...
   * copied.
   */
  fun copyInto(array: UByteArray, offset: Int = 0) {
  ...
  override fun slice(range: IntRange) = UByteDeque(sliceToArray(range.first, range.last+1), 0)

  override fun sliceToArray(start: Int, end: Int): UByteArray {
