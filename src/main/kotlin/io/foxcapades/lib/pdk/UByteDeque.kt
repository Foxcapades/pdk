...
class UByteDeque : PrimitiveDeque<UByte, UByteArray> {
   ...
   * deque.
   */
  fun pushTail(values: UByteArray) {
   ...
   * deque.
   */
  inline fun pushLast(values: UByteArray) = pushTail(values)
   ...
   * deque.
   */
  inline fun pushBack(values: UByteArray) = pushTail(values)
  ...
  inline operator fun plusAssign(values: UByteArray) = pushTail(values)
