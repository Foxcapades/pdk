...
class ULongDeque : PrimitiveDeque<ULong, ULongArray> {
  ...
  private var container: ULongArray
  ...
  /**
   * Constructs a new, empty [ULongDeque] instance.
   *
   * @param capacity Initial capacity to create this deque with.
   */
  constructor(capacity: Int = 0) {
    this.container = ULongArray(capacity)
  }

  /**
   * Constructs a new [ULongDeque] instance copying the given values.
   *
   * @param data Array of values to copy into the new deque.
   */
  constructor(data: ULongArray) {
    this.container = data.copyOf()
    this.size = data.size
  }

  /**
   * Constructs a new [ULongDeque] instance wrapping the given values.
   *
   * @param data Raw array that will back the new instance.
   *
   * @param head Internal head position for the new instance.
   */
  private constructor(data: ULongArray, head: Int) {
    this.container     = data
    this.size     = data.size
    this.realHead = head
  }
   ...
   * @param value Value that will be pushed onto the front of this deque.
   */
  inline fun pushHead(value: ULong) = push(value)
   ...
   * @param value Value that will be pushed onto the front of this deque.
   */
  inline fun pushFirst(value: ULong) = push(value)
   ...
   * @param value Value that will be pushed onto the front of this deque.
   */
  inline fun pushFront(value: ULong) = push(value)
   ...
   * @throws NoSuchElementException If this deque is empty.
   */
  inline fun popLast(): ULong = popTail()
   ...
   * @throws NoSuchElementException If this deque is empty.
   */
  inline fun popBack(): ULong = popTail()
   ...
   * @param value Value that will be pushed onto the back of this deque.
   */
  inline fun pushLast(value: ULong) = pushTail(value)
   ...
   * @param value Value that will be pushed onto the back of this deque.
   */
  inline fun pushBack(value: ULong) = pushTail(value)
   ...
   * @param value Value that will be pushed onto the back of this deque.
   */
  inline operator fun plusAssign(value: ULong) = pushTail(value)
  ...
  override fun pushTail(values: ULongArray) {
  ...
  override fun pushTail(values: Collection<ULong>) {
    ensureCapacity(size + values.size)
    for (v in values)
      pushTail(v)
  }
   ...
   */
  fun pushTail(values: ULongDeque) {
   ...
   * @param values Deque that will be pushed onto the back of this deque.
   */
  inline fun pushLast(values: ULongDeque) = pushTail(values)
   ...
   * @param values Deque that will be pushed onto the back of this deque.
   */
  inline fun pushBack(values: ULongDeque) = pushTail(values)
   ...
   * @param values Deque that will be pushed onto the back of this deque.
   */
  inline operator fun plusAssign(values: ULongDeque) = pushTail(values)
   ...
   */
  operator fun set(index: Int, value: ULong) = container.set(internalIndex(validExtInd(index)), value)
  ...
  override fun copy() = ULongDeque(container.copyOf(), realHead)
  ...
  override fun toArray(): ULongArray {
  ...
  override fun slice(start: Int, end: Int) = ULongDeque(sliceToArray(start, end), 0)

  override fun slice(range: IntRange) = ULongDeque(sliceToArray(range.first, range.last+1), 0)

  override fun sliceToArray(start: Int, end: Int): ULongArray {
  ...
  override fun equals(other: Any?) = if (other is ULongDeque) container.contentEquals(other.container) else false
