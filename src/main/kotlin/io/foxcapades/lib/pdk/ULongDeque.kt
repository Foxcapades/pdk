...
class ULongDeque : PrimitiveDeque<ULong, ULongArray> {
  ...
  override fun copy(): ULongDeque {
    val nb = ULongDeque(data)
  ...
  override fun toList(): List<ULong> {
    return toArray().asList()
  }

  override fun copyInto(array: ULongArray, offset: Int) {
