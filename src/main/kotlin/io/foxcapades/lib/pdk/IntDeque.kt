...
class IntDeque : PrimitiveDeque<Int, IntArray> {
  ...
  private var container: IntArray
  ...
  constructor(capacity: Int = 0) {
    this.container = IntArray(capacity)
  }
   ...
   * @param value Value that will be pushed onto the front of this deque.
   */
  inline fun pushHead(value: Int) = push(value)
   ...
   * @param value Value that will be pushed onto the front of this deque.
   */
  inline fun pushFirst(value: Int) = push(value)
   ...
   * @param value Value that will be pushed onto the front of this deque.
   */
  inline fun pushFront(value: Int) = push(value)
   ...
   * @throws NoSuchElementException If this deque is empty.
   */
  inline fun popLast(): Int = popTail()
   ...
   * @throws NoSuchElementException If this deque is empty.
   */
  inline fun popBack(): Int = popTail()
   ...
   * @param value Value that will be pushed onto the back of this deque.
   */
  inline fun pushLast(value: Int) = pushTail(value)
   ...
   * @param value Value that will be pushed onto the back of this deque.
   */
  inline fun pushBack(value: Int) = pushTail(value)
  ...
  override fun pushTail(values: IntArray) {
  ...
  override fun pushTail(values: Collection<Int>) {
    ensureCapacity(size + values.size)
    for (v in values)
      pushTail(v)
  }
   ...
   */
  operator fun set(index: Int, value: Int) = container.set(internalIndex(validExtInd(index)), value)
  ...
  override fun copy() = IntDeque(container.copyOf(), realHead)
   ...
   * copied.
   */
  fun copyInto(array: IntArray, offset: Int = 0) {
  ...
  override fun slice(start: Int, end: Int) = IntDeque(sliceToArray(start, end), 0)

  override fun slice(range: IntRange) = IntDeque(sliceToArray(range.first, range.last+1), 0)

  override fun sliceToArray(start: Int, end: Int): IntArray {
  ...
  override fun equals(other: Any?) = if (other is IntDeque) container.contentEquals(other.container) else false
