...
class IntDeque : PrimitiveDeque<Int, IntArray> {
   ...
   * deque.
   */
  inline fun pushLast(values: IntArray) = pushTail(values)
   ...
   * deque.
   */
  inline fun pushBack(values: IntArray) = pushTail(values)
  ...
  inline operator fun plusAssign(values: IntArray) = pushTail(values)
