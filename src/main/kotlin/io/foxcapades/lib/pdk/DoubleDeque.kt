...
class DoubleDeque : PrimitiveDeque<Double, DoubleArray> {
   ...
   * deque.
   */
  fun pushTail(values: DoubleArray) {
   ...
   * deque.
   */
  inline fun pushLast(values: DoubleArray) = pushTail(values)
   ...
   * deque.
   */
  inline fun pushBack(values: DoubleArray) = pushTail(values)
  ...
  inline operator fun plusAssign(values: DoubleArray) = pushTail(values)
