...
class UIntDeque : PrimitiveDeque<UInt, UIntArray> {
  ...
  private var container: UIntArray
   ...
   * @param value Value that will be pushed onto the front of this deque.
   */
  inline fun pushHead(value: UInt) = push(value)
   ...
   * @param value Value that will be pushed onto the front of this deque.
   */
  inline fun pushFirst(value: UInt) = push(value)
   ...
   * @param value Value that will be pushed onto the front of this deque.
   */
  inline fun pushFront(value: UInt) = push(value)
   ...
   * @throws NoSuchElementException If this deque is empty.
   */
  inline fun popLast(): UInt = popTail()
   ...
   * @throws NoSuchElementException If this deque is empty.
   */
  inline fun popBack(): UInt = popTail()
   ...
   * @param value Value that will be pushed onto the back of this deque.
   */
  inline fun pushLast(value: UInt) = pushTail(value)
   ...
   * @param value Value that will be pushed onto the back of this deque.
   */
  inline fun pushBack(value: UInt) = pushTail(value)
   ...
   * @param value Value that will be pushed onto the back of this deque.
   */
  inline operator fun plusAssign(value: UInt) = pushTail(value)
  ...
  override fun pushTail(values: UIntArray) {
  ...
  override fun pushTail(values: Collection<UInt>) {
    ensureCapacity(size + values.size)
    for (v in values)
      pushTail(v)
  }
   ...
   * @param values Deque that will be pushed onto the back of this deque.
   */
  inline fun pushLast(values: UIntDeque) = pushTail(values)
   ...
   * @param values Deque that will be pushed onto the back of this deque.
   */
  inline fun pushBack(values: UIntDeque) = pushTail(values)
   ...
   * @param values Deque that will be pushed onto the back of this deque.
   */
  inline operator fun plusAssign(values: UIntDeque) = pushTail(values)
   ...
   */
  operator fun set(index: Int, value: UInt) = container.set(internalIndex(validExtInd(index)), value)
  ...
  override fun copy() = UIntDeque(container.copyOf(), realHead)
  ...
  override fun toArray(): UIntArray {
  ...
  override fun slice(start: Int, end: Int) = UIntDeque(sliceToArray(start, end), 0)

  override fun slice(range: IntRange) = UIntDeque(sliceToArray(range.first, range.last+1), 0)

  override fun sliceToArray(start: Int, end: Int): UIntArray {
  ...
  override fun equals(other: Any?) = if (other is UIntDeque) container.contentEquals(other.container) else false
