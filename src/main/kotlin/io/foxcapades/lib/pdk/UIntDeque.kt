...
class UIntDeque : PrimitiveDeque<UInt, UIntArray> {
   ...
   * deque.
   */
  inline fun pushLast(values: UIntArray) = pushTail(values)
   ...
   * deque.
   */
  inline fun pushBack(values: UIntArray) = pushTail(values)
  ...
  inline operator fun plusAssign(values: UIntArray) = pushTail(values)
