...
class UShortDeque : PrimitiveDeque<UShort, UShortArray> {
  ...
  /**
   * Constructs a new [UShortDeque] instance wrapping the given values.
   *
  ...
  override fun slice(range: IntRange) = UShortDeque(sliceToArray(range.first, range.last+1), 0)
