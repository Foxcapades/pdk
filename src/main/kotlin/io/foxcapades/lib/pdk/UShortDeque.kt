...
class UShortDeque : PrimitiveDeque<UShort, UShortArray> {
   ...
   * deque.
   */
  fun pushTail(values: UShortArray) {
   ...
   * deque.
   */
  inline fun pushLast(values: UShortArray) = pushTail(values)
   ...
   * deque.
   */
  inline fun pushBack(values: UShortArray) = pushTail(values)
  ...
  inline operator fun plusAssign(values: UShortArray) = pushTail(values)
