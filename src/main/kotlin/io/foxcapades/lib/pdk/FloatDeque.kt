...
class FloatDeque : PrimitiveDeque<Float, FloatArray> {
  ...
  private var container: FloatArray
  ...
  constructor(capacity: Int = 0) {
    this.container = FloatArray(capacity)
  }
   ...
   */
  fun pushTail(values: FloatDeque) {
   ...
   * @param values Deque that will be pushed onto the back of this deque.
   */
  inline fun pushLast(values: FloatDeque) = pushTail(values)
   ...
   * @param values Deque that will be pushed onto the back of this deque.
   */
  inline fun pushBack(values: FloatDeque) = pushTail(values)
   ...
   * @param values Deque that will be pushed onto the back of this deque.
   */
  inline operator fun plusAssign(values: FloatDeque) = pushTail(values)
   ...
   */
  operator fun set(index: Int, value: Float) = container.set(internalIndex(validExtInd(index)), value)
  ...
  override fun copy() = FloatDeque(container.copyOf(), realHead)
  ...
  override fun equals(other: Any?) = if (other is FloatDeque) container.contentEquals(other.container) else false
